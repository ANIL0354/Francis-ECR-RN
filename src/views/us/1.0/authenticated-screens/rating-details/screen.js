            ...
            <ScrollView
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: scaleText(20).fontSize, }}>
                    ...
                    <View style={{ flex: 1, width: '100%', paddingBottom: scaleText(10).fontSize, borderColor: 'transparent', borderBottomColor: 'rgb(222,219,219)', borderWidth: 1 }}>
                        ...
                        <Text style={{ color: 'black', fontSize: scaleText(14).fontSize, textAlign: 'left' }}>{'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sed augue nec lorem lobortis hendrerit. Quisque vel erat et justo vulputate commodo id id arcu. In semper velit massa, cursus efficitur tellus imperdiet et. '}</Text>
                    </View>
