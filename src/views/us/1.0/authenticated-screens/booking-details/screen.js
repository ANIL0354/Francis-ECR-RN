                                ...
                                {completeDetails && completeDetails.insurancrData
                                    ? <React.Fragment>
                                        ...
                                        <View style={{ flex: 1, paddingVertical: scaleText(3).fontSize }}>
                                            ...
                                            <Text style={{ color: 'black', flex: 1, fontSize: scaleText(14).fontSize, textTransform: 'capitalize' }}>{`${completeDetails.insurancrData.description} lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum`}</Text>
                                        </View>
                                        <Text style={{
                                            color: 'black', flex: 1, marginVertical: scaleText(5).fontSize, fontSize: scaleText(15).fontSize, fontWeight: 'bold'
