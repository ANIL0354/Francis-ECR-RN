...
export const Screen = ({
    ...
    const agencyCommentField = useRef();
    const ecrCommentField = useRef();
        ...
        >
            <ScrollView
                ...
                <TouchableWithoutFeedback onPress={(event) => {
                    if (event.target === agencyCommentField.current) {
                        return;
                    }
                    else if (event.target === ecrCommentField.current) {
                        return;
                    }
                    else {
                        Keyboard.dismiss();
                    ...
                    <View
                        ...
                        <View style={{ flex: 1, paddingVertical: scaleText(20).fontSize, justifyContent: 'center', alignItems: 'center', paddingHorizontal: scaleText(20).fontSize, }}>
